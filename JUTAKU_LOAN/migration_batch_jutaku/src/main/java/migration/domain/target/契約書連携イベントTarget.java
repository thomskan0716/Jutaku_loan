...
/**
 * Target: 契約書連携イベント (Contract document linkage event) - ITF_SMS.
 * Source is 審査契約書出力連携. 申込番号 first digit 2->3; 申込目的 converted by service.
 */
public class 契約書連携イベントTarget {
