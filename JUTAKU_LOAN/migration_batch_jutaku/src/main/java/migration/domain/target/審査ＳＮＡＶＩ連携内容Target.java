...
/**
 * Target: 審査ＳＮＡＶＩ連携内容 (Review S-NAVI linkage content) - ITF_SMS.
 * 105 columns. 申込番号 first digit 2->3; 申込目的 converted by service; rest pass-through.
 * 段階保証料率コード is sourced from 上乗せ保証料 (aliased in the source SQL).
 */
public class 審査ＳＮＡＶＩ連携内容Target {
