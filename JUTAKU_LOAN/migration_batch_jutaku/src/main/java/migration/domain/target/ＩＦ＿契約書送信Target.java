...
/**
 * Target: ＩＦ＿契約書送信 (contract-document send interface) - ITF_SMS.
 * Sourced from SZB_SMS.審査契約書出力連携内容 (143 columns).
 * 申込番号 first digit 2->3; 申込目的 converted by service; rest pass-through.
 * Table name uses full-width underscores ＿ (U+FF3F) — double-quoted in Oracle SQL.
 * Numbered columns use full-width digits (１ etc.) in the DB; #{} params keep half-width Java names.
 */
public class ＩＦ＿契約書送信Target {
