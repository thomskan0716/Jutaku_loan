...
/**
 * Target: 保証検討表補足 (Guarantee Review Sheet Supplement, main table) - ITF_SMS
 * Inserted once per group using MAX 申込目的, same pattern as 保証人Target.
 */
public class 保証検討表補足Target {
