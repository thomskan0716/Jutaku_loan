...
/**
 * Target: 個信類似照会明細 (Personal-credit similar inquiry detail) - ITF_SMS
 * 申込番号 first digit 2→3; 申込目的 converted by service. Other columns pass through.
 * DB uses full-width digits (電話番号１/電話番号２) and full-width underscores (再照会＿*).
 */
public class 個信類似照会明細Target {
