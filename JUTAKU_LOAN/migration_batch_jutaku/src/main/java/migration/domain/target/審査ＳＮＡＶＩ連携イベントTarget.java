...
/**
 * Target: 審査ＳＮＡＶＩ連携イベント (Review S-NAVI linkage event) - ITF_SMS.
 * Source is 審査ＳＮＡＶＩ連携. 申込番号 first digit 2->3; 申込目的 converted by service.
 */
public class 審査ＳＮＡＶＩ連携イベントTarget {
