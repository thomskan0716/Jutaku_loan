...
/**
 * Target: 保証結果メインアルヒ (Guarantee result main - ARUHI external linkage) - ITF_SMS.
 * 外部連携. 1:N per (申込番号, 申込目的). 申込番号 2->3 and 申込目的 converted by service.
 *
 ...
 * in the DB column name; Java properties keep half-width digits (mapped in the INSERT).</p>
 *
 * <p>NOTE: this is a partial column set; more columns will be added later.</p>
 */
public class 保証結果メインアルヒTarget {
