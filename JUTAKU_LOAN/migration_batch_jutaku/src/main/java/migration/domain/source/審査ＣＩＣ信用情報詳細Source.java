...
/**
 * Source: 審査ＣＩＣ信用情報詳細 (Review CIC credit info detail) - SZB_SMS.
 * Same layout as 審査ＫＳＣ信用情報詳細, except the header uses
 * 会員名 / 回答通番 / 電文種別 instead of 該当者通番.
 */
public class 審査ＣＩＣ信用情報詳細Source {
