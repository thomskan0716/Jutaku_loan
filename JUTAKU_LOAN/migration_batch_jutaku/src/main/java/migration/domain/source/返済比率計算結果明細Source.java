...
/**
 * Source: 返済比率計算結果明細 (Repayment-ratio calculation result detail) - SZB_SMS.
 * Same 57 data columns as 返済比率計算結果 but keyed with an extra 連番.
 */
public class 返済比率計算結果明細Source {
