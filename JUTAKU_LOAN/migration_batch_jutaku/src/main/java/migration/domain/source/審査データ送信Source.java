...
/**
 * Source: 審査データ送信 (Review data transmission) - SZB_SMS.
 * 1:N per (申込番号, 申込目的), keyed by イベント/イベント日時.
 */
public class 審査データ送信Source {
    ...
    private String 次進捗コード;  // VARCHAR2(8)
    private String 次状態;        // VARCHAR2(10)
    ...
    public String get次進捗コード() { return 次進捗コード; }
    public void set次進捗コード(String v) { this.次進捗コード = v; }

    public String get次状態() { return 次状態; }
    public void set次状態(String v) { this.次状態 = v; }
}
