...
/**
 * Source: 審査モデル回答明細 (Scoring model answer detail) - SZB_SMS.
 * 1:N per (申込番号, 申込目的). Per-factor 評点/係数/スコア are NUMBER(13,10);
 * 合算返済比率 / 自己資金比率 are NUMBER(7,4).
 */
public class 審査モデル回答明細Source {
