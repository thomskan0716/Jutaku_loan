...
/**
 * Source: 保証結果メインじぶん (Guarantee result main - au Jibun external linkage) - SZB_SMS.
 ...
 * the DB column name; Java properties keep half-width digits (mapped in the resultMap).</p>
 *
 * <p>NOTE: this is a partial column set; more columns will be added later.</p>
 */
public class 保証結果メインじぶんSource {
    ...
    private Date 出力日時;        // DATE
    private String 保証会社案件番号; // VARCHAR2(12)
    private String 外部案件番号;  // VARCHAR2(12)
    private String 申込人姓名カナ; // VARCHAR2(54)
    private String 申込人姓名;    // VARCHAR2(34)
    private String 申込人性別;    // VARCHAR2(1)
    private String 申込人生年月日; // VARCHAR2(8)
    private String 申込人郵便番号; // VARCHAR2(7)
    private String 申込人住所;    // VARCHAR2(200)
    private String 申込人現住所電話番号; // VARCHAR2(15)
    private String 申込人携帯電話番号; // VARCHAR2(15)
    private String 申込人勤務先名称; // VARCHAR2(120)
    private String 申込人勤務先郵便番号; // VARCHAR2(7)
    private String 申込人勤務先住所; // VARCHAR2(200)
    private String 申込人勤務先電話番号; // VARCHAR2(15)
    private String 申込人勤続年数; // VARCHAR2(2)
    private String 申込人雇用形態; // VARCHAR2(2)
    private String 申込人業種;    // VARCHAR2(50)
    private String 申込人勤務先資本金; // VARCHAR2(9)
    private String 申込人勤務先従業員数; // VARCHAR2(8)
    private String 申込人勤務先職種役職; // VARCHAR2(2)
    private String 申込人勤務先所属部署; // VARCHAR2(30)
    private String 国家資格;      // VARCHAR2(2)
    private String 申込本人前年年収; // VARCHAR2(12)
    private String 保有資産;      // VARCHAR2(6)
    private String ペアローン有無; // VARCHAR2(1)
    private String ペアローン案件番号; // VARCHAR2(12)
    ...
    private String 資金使途;      // VARCHAR2(2)
    private String 建設地郵便番号; // VARCHAR2(7)
    private String 建設地住所;    // VARCHAR2(200)
    private String 売買契約予定年月日; // VARCHAR2(8)
    private String 建物新築年月日; // VARCHAR2(8)
    private String 婚姻区分;      // VARCHAR2(1)
    private String 同居家族配偶者; // VARCHAR2(1)
    private String 同居家族子供人数; // VARCHAR2(3)
    private String 同居家族その他人数; // VARCHAR2(3)
    private String 住居区分;      // VARCHAR2(1)
    private String 必要資金土地;  // VARCHAR2(6)
    private String 必要資金建物;  // VARCHAR2(6)
    private String 必要資金借替;  // VARCHAR2(6)
    private String 必要資金諸費用; // VARCHAR2(6)
    private String 必要資金その他; // VARCHAR2(6)
    private String 融資額;        // VARCHAR2(5)
    private String 返済方法;      // VARCHAR2(1)
    private String 希望返済期間;  // VARCHAR2(3)
    private String 希望額ボーナス分; // VARCHAR2(5)
    private String 希望額毎月分;  // VARCHAR2(5)
    private String 融資実行希望年月日; // VARCHAR2(8)
    ...
    private String 資産売却;      // VARCHAR2(6)
    private String 自己資金;      // VARCHAR2(6)
    private String 自己資金うち贈与資金; // VARCHAR2(6)
